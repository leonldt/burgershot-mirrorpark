...
const ACTIONS: Record<string, string> = {
  ...
  SUPPLIER_PRODUCT_UPDATED: "Lieferprodukt gepflegt",
  SUPPLIER_PRODUCT_REMOVED: "Lieferprodukt entfernt",
  PURCHASE_LIST_CREATED: "Einkaufsliste erstellt",
  PURCHASE_LIST_DELIVERED: "Einkaufsliste bestätigt (geliefert)",
